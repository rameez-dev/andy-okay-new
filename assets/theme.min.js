...
window.fetch = function() {
   ...
   var promise = newFetch.apply(this, arguments)
   if(arguments && arguments[0] && arguments[0].indexOf('/cart') > -1) {
     promise.then(function() { 
       setTimeout(function() {
         if(window.UploadKit && window.UploadKit.scanAttributes) { window.UploadKit.scanAttributes()}
       }, 200)
     })
   }
   return promise
